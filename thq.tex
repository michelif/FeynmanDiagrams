...
\fmfright{o1,o2,o3,o4,o5} \fmflabel{{\Large $b$}}{o1} \fmflabel{{\Large $W$}}{o2}\fmflabel{{\Large $\gamma$}}{o3}\fmflabel{{\Large $\gamma$}}{o4}
\fmflabel{{\Large $q^{'}$}}{o5}
\unitlength = 1mm
...
\fmf{dashes,label={\Large $H$},label.side=left}{v3,v5} %questo è l'Higgs
\fmf{photon}{o4,v5}
\fmf{photon}{v5,o3}
%\fmf{photon}{v6,o3}%giusto per allungare un po' la gamba del fotone
\fmf{boson}{v4,o2} 
...
\fmfforce{.5w,0.4h}{v1}
\fmfforce{.7w,0.4h}{v3}
\fmfforce{.87w,0.6h}{v5}
\fmfforce{.98w,.425h}{o3}
